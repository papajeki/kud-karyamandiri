...
<div class="d-flex" style="margin:1em;">
    <!-- search -->
    <form class="d-flex" action="<?= base_url('ksp/pinjaman')?>" method="get">
    ...
    <button class="btn btn-primary" type="submit" style="margin-inline-start: auto;">
        <a href="<?= base_url('ksp/tambah_pinjaman')?>" style="text-decoration:none; color:white;">Daftarkan Pinjaman</a></button>
</div>
<?= $this->include('components/daftarpeminjam') ?>
