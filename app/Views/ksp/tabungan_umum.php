...
<div class="d-flex" style="margin:1em;">
    <!-- search -->
    <form class="d-flex" action="<?= base_url('ksp/tabungan_kapling')?>" method="get">
    ...
    <button class="btn btn-primary" type="submit" style="margin-inline-start: auto;">
        <a href="<?= base_url('ksp/bukutabungan')?>" style="text-decoration:none; color:white;">Tambah Buku Tabungan</a></button>
</div>

<?= $this->include('components/daftartabungankapling') ?>
<?= $this->endsection() ?>